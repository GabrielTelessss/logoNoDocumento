...
function gerarArquivoA4() {
    ...
    reader1.onload = function(e1) {
        ...
        img1.onload = function() {
            ...
            // Ajusta as imagens para caber no formato PDF
            ...
            const newWidthImg1 = 118; // Ajuste de largura
            const newHeightImg1 = newWidthImg1 / aspectRatioImg1;

            pdfDocument.setGState(new pdfDocument.GState({ opacity: 0.1 }));
            pdfDocument.addImage(img1, 'JPEG', 43, 140, newWidthImg1, newHeightImg1); // X, y, largura, altura
...
async function downloadBmp() {
    ...
    loadingTask.promise.then(async function(pdf) {
        ...
        renderTask.promise.then(function() {
            ...
            link.download = 'CriticaDaOS_24bits.bmp';
            link.click();

        ...
        reader2.onload = function(e2) {
            ...
            img1.onload = function() {
                img2.onload = function() {
                    ...
                    // Ajusta as imagens para caber no formato no PDF
                    ...
                    const newWidthImg2 = 130;
                    const newHeightImg2 = newWidthImg2 / aspectRatioImg2;

                    pdfDocument.addImage(img2, 'JPEG', 2.5, 60, newWidthImg2, newHeightImg2); // X, y, largura, altura
...
async function downloadBmp() {
    ...
    loadingTask.promise.then(async function(pdf) {
        ...
        renderTask.promise.then(function() {
            ...
            link.download = 'orcamento_24bits.bmp';
            link.click();
